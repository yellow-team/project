...
public class StudentUnitRecordMap extends java.util.HashMap<String, IStudentUnitRecord>
{
    ...
    /**
     * Avoids programmer needing to know 'magic formula' for the key. Has same name as Map's
     * method to increase familiarity and make it easy to stumble across this one instead of
     * Map's.
     */
    ...
    //TODO: find out how to disable super's methods from being accessed to force use of these.
}
